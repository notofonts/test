...
* ⚠️ **WARN** <p>Family metadata at fonts/NotoSerifTest/googlefonts/variable does not have an article.</p>
 [code: lacks-article]
...
<details><summary>[15] NotoSerifTest[wght].ttf</summary>
<div>
<details>
...
<pre><code>* asterisk (U+002A): X=76.0,Y=698.0 (should be at cap-height 700?)
...
* s (U+0073): X=369.5,Y=499.0 (should be at x-height 500?)
...
<p>Your font does <em>not</em> cover the following languages that require the soft-dotted feature: Dan (Latn, 1,099,244 speakers), Ekpeye (Latn, 226,000 speakers), Kom (Latn, 360,685 speakers), Fur (Latn, 1,230,163 speakers), Ebira (Latn, 2,200,000 speakers), Nzakara (Latn, 50,000 speakers), Ma’di (Latn, 584,000 speakers), Makaa (Latn, 221,000 speakers), Bafut (Latn, 158,146 speakers), Lugbara (Latn, 2,200,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Dii (Latn, 71,000 speakers), Koonzime (Latn, 40,000 speakers), Gulay (Latn, 250,478 speakers), Cicipu (Latn, 44,000 speakers), Sar (Latn, 500,000 speakers), South Central Banda (Latn, 244,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Aghem (Latn, 38,843 speakers), Basaa (Latn, 332,940 speakers), Southern Kisi (Latn, 360,000 speakers), Ejagham (Latn, 120,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Igbo (Latn, 27,823,640 speakers), Zapotec (Latn, 490,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Mfumte (Latn, 79,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Navajo (Latn, 166,319 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Avokaya (Latn, 100,000 speakers), Yala (Latn, 200,000 speakers), Mundani (Latn, 34,000 speakers), Nateni (Latn, 100,000 speakers), Mango (Latn, 77,000 speakers).</p>
 [code: soft-dotted]
...
<li>U+0307 COMBINING DOT ABOVE: try adding one of: coptic, malayalam, old-permic, syriac, math, canadian-aboriginal, tai-le, tifinagh</li>
...
* 🔥 **FAIL** <p>OS/2.fsSelection bit 7 (USE_TYPO_METRICS) wasNOT set in the following fonts: ['fonts/NotoSerifTest/googlefonts/variable/NotoSerifTest[wght].ttf'].</p>
